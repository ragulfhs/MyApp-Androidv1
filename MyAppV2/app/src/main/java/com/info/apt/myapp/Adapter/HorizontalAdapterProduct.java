...
public class HorizontalAdapterProduct extends RecyclerView.Adapter<HorizontalAdapterProduct.RecyclerVH> {
    Context c;
    String[] spacecrafts;

    public HorizontalAdapterProduct(Context c, String[] spacecrafts) {
        this.c = c;
    ...
    public RecyclerVH onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(c).inflate(R.layout.product_single_item, parent, false);

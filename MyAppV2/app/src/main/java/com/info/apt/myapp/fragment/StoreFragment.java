...
import com.info.apt.myapp.Adapter.ImageSlideAdapter;
...
public class StoreFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pagerIndicator = (LinearLayout) rootView.findViewById(R.id.viewPagerIndicator);

        mPager = (ViewPager) rootView.findViewById(R.id.viewPager);

        adapter = new ImageSlideAdapter(getActivity());
